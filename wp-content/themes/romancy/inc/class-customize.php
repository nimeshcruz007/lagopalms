...
if (!class_exists( 'Romancy_Customize' )){

	class Romancy_Customize {
		
		public function __construct() {
	        add_action( 'customize_register', array( $this, 'romancy_customize_register' ) );
	    }

	    public function romancy_customize_register($wp_customize) {
	        
	        $this->romancy_init_remove_setting( $wp_customize );
	        $this->romancy_init_ova_typography( $wp_customize );
	        $this->romancy_init_ova_color( $wp_customize );
	        $this->romancy_init_ova_layout( $wp_customize );
	        $this->romancy_init_ova_header( $wp_customize );
	        $this->romancy_init_ova_footer( $wp_customize );
	        $this->romancy_init_ova_blog( $wp_customize );
	        
	        if( romancy_is_woo_active() ){
	        	$this->romancy_init_ova_woo( $wp_customize );	
	        }
	   
	        do_action( 'romancy_customize_register', $wp_customize );
	    }

	    public function romancy_init_remove_setting( $wp_customize ){
		    ...
		    $wp_customize->add_control( new WP_Customize_Image_Control( $wp_customize, 'logo', array(
		        'label'    => esc_html__( 'Logo Default', 'romancy' ),
	    ...
	    /* Typo */
	    public function romancy_init_ova_typography($wp_customize){

	    		/* Body Pane ******************************/
				$wp_customize->add_section( 'typo_general' , array(
				    'title'      => esc_html__( 'Typography', 'romancy' ),
				    'priority'   => 1,
				    // 'panel' => 'typo_panel',
				) );
					...
					$wp_customize->add_control(
						new Romancy_Customize_Control_Heading( 
						$wp_customize, 
						'text_typo_message', 
						array(
							'label'		=> esc_html__('Text Font','romancy'),
						...
						$wp_customize->add_control('general_font_size', array(
							...
							'description' 	=> esc_html__('Example: 16px, 1.2em','romancy'),
							'section' 		=> 'typo_general',
						...
						$wp_customize->add_control('general_line_height', array(
							'label' 		=> esc_html__('Line height','romancy'),
							'description' 	=> esc_html__('Recommend use em. Example: 1.6em, 23px','romancy'),
							'section' 		=> 'typo_general',
						...
						$wp_customize->add_control('general_letter_space', array(
							'label' 		=> esc_html__('Letter Spacing','romancy'),
							'description' 	=> esc_html__('Example: 0px, 0.5em','romancy'),
							'section' 		=> 'typo_general',
				...
				$wp_customize->add_control(
					...
					'general_heading', 
					array(
						'label' 	=> esc_html__('Primary Font','romancy'),
			            'section' 	=> 'typo_general',
				...
				$wp_customize->add_setting( 'primary_font',
					array(
						'default' 			=> romancy_default_primary_font(),
						'sanitize_callback' => 'romancy_google_font_sanitization'
					)
				);
					$wp_customize->add_control( new Romancy_Google_Font_Select_Custom_Control( $wp_customize, 'primary_font',
						array(
							'label' 			=> esc_html__( 'Primary Font', 'romancy' ),
							'section' 			=> 'typo_general',
							'input_attrs' 		=> array(
				...
				$wp_customize->add_control(
					...
					'second_font_message', 
					array(
						'label' 	=> esc_html__('Second Font','romancy'),
			            'section' 	=> 'typo_general',
					...
					$wp_customize->add_setting( 'second_font',
						array(
							'default' 			=> romancy_default_second_font(),
							'sanitize_callback' => 'romancy_google_font_sanitization'
						)
					);
					$wp_customize->add_control( new Romancy_Google_Font_Select_Custom_Control( $wp_customize, 'second_font',
						array(
							'label' 			=> esc_html__( 'Font', 'romancy' ),
							'section' 			=> 'typo_general',
							'input_attrs' 		=> array(
								'font_count' 	=> 'all',
								'orderby' 		=> 'popular',
				...
				$wp_customize->add_control(
					...
					'custom_font_message', 
					array(
						'label' 	=> esc_html__('Custom Font','romancy'),
			            'section' 	=> 'typo_general',
					...
					$wp_customize->add_control('ova_custom_font', array(
						...
						'description' 	=> esc_html__('Step 1: Insert font-face in style.css file: Refer https://www.w3schools.com/cssref/css3_pr_font-face_rule.asp. Step 2: Insert font-family and font-weight like format: 
							["Perpetua", "Regular:Bold:Italic:Light"] | ["Name-Font", "Regular:Bold:Italic:Light"]. Step 3: Refresh customize page to display new font in dropdown font field.','romancy'),
						'section' 		=> 'typo_general',
	     ...
	     /* Color */
	    public function romancy_init_ova_color( $wp_customize ){

	    	/* Body Pane ******************************/
			$wp_customize->add_section( 'color_section' , array(
			    'title'      => esc_html__( 'Color', 'romancy' ),
			    'priority'   => 2,
			    // 'panel' => 'typo_panel',
			) );
				...
				$wp_customize->add_control(
					...
					'primary_color', 
					array(
						'label' 	=> esc_html__("Primary",'romancy'),
				...
				$wp_customize->add_control(
					...
					'secondary_color', 
					array(
						'label' 	=> esc_html__("Secondary",'romancy'),
			            'section' 	=> 'color_section',
				...
				$wp_customize->add_control(
					...
					'heading_color', 
					array(
						'label' 	=> esc_html__("Heading",'romancy'),
			            'section' 	=> 'color_section',
				...
				$wp_customize->add_control(
					...
					'light_color', 
					array(
						'label' 	=> esc_html__("Light",'romancy'),
			            'section' 	=> 'color_section',
	    ...
	    /* Layout */
	    public function romancy_init_ova_layout( $wp_customize ){

	    	$wp_customize->add_section( 'layout_section' , array(
			    'title'      => esc_html__( 'Layout', 'romancy' ),
			    'priority'   => 2,
			) );
				...
				$wp_customize->add_control('global_boxed_container_width', array(
					'label' 	=> esc_html__('Container (px)','romancy'),
				...
				$wp_customize->add_control('global_layout', array(
					'label' 	=> esc_html__('Layout','romancy'),
					'section' 	=> 'layout_section',
					'settings' 	=> 'global_layout',
					'type' 		=>'select',
					'choices' 	=> apply_filters( 'romancy_define_layout', '' )
				));
				...
				$wp_customize->add_control('global_sidebar_width', array(
					'label' 	=> esc_html__('Sidebar Width (px)','romancy'),
					'section' 	=> 'layout_section',
				...
				$wp_customize->add_control('global_wide_site', array(
					'label' 	=> esc_html__('Wide Site','romancy'),
					'section' 	=> 'layout_section',
					'settings' 	=> 'global_wide_site',
					'type' 		=>'select',
					'choices' 	=> apply_filters('romancy_define_wide_boxed', '')
				));
				...
				$wp_customize->add_control('global_boxed_offset', array(
					'label' 	=> esc_html__('Boxed Offset (px)','romancy'),
					'section' 	=> 'layout_section',
	    ...
	    /* Header */
	    public function romancy_init_ova_header( $wp_customize ){

	    	$wp_customize->add_section( 'header_section' , array(
			    'title'      => esc_html__( 'Header', 'romancy' ),
			    'priority'   => 3,
			) );
				...
				$wp_customize->add_control('global_header', array(
					'label' 		=> esc_html__('Header Default','romancy'),
					'description' 	=> esc_html__('This isn\'t effect in Blog' ,'romancy'),
	    ...
	    /* Footer */
	    public function romancy_init_ova_footer( $wp_customize ){

	    	$wp_customize->add_section( 'footer_section' , array(
			    'title'      => esc_html__( 'Footer', 'romancy' ),
			    'priority'   => 4,
			) );
				...
				$wp_customize->add_control('global_footer', array(
					'label' 		=> esc_html__('Footer Default','romancy'),
					'description' 	=> esc_html__('This isn\'t effect in Blog' ,'romancy'),
	    ...
	    /* Blog */
	    public function romancy_init_ova_blog( $wp_customize ){

	    	$wp_customize->add_panel( 'blog_panel', array(
			    'title'		=> esc_html__( 'Blog', 'romancy' ),
			    'priority' 	=> 5,
			) );

				$wp_customize->add_section( 'blog_section' , array(
				    'title' 	=> esc_html__( 'Archive', 'romancy' ),
				    'priority' 	=> 30,
				    'panel' 	=> 'blog_panel',
				) );
					...
					$wp_customize->add_control('blog_template', array(
						...
						'type' 		=>'select',
						'choices' 	=> array(
							'default' 	=> esc_html__('Default', 'romancy'),
							'grid'		=> esc_html__('Grid', 'romancy'),
							'masonry' 	=> esc_html__('Masonry', 'romancy'),
						)
					));
					...
					$wp_customize->add_control('blog_archive_show_media', array(
						'label' 	=> esc_html__('Show Media','romancy'),
						'section' 	=> 'blog_section',
					...
					$wp_customize->add_control('blog_archive_show_date', array(
						'label' 	=> esc_html__('Show Date','romancy'),
						'section' 	=> 'blog_section',
					...
					$wp_customize->add_control('blog_archive_show_author', array(
						'label' 	=> esc_html__('Show Author','romancy'),
						'section' 	=> 'blog_section',
					...
					$wp_customize->add_control('blog_archive_show_excerpt', array(
						'label' 	=> esc_html__('Show Excerpt','romancy'),
						'section' 	=> 'blog_section',
					...
					$wp_customize->add_control('blog_header', array(
						'label' 	=> esc_html__('Header','romancy'),
						'section' 	=> 'blog_section',
					...
					$wp_customize->add_control('blog_footer', array(
						'label' 	=> esc_html__('Footer','romancy'),
						'section' 	=> 'blog_section',
				...
				$wp_customize->add_section( 'single_section' , array(
				    'title' 	=> esc_html__( 'Single', 'romancy' ),
				    'priority' 	=> 30,
				    'panel' 	=> 'blog_panel',
				) );	
					...
					$wp_customize->add_control('blog_single_show_tag', array(
						'label' 	=> esc_html__('Show Tag','romancy'),
						'section' 	=> 'single_section',
	    ...
	    public function romancy_init_ova_woo( $wp_customize ){
			...
			$wp_customize->add_control('woo_archive_layout', array(
				'label'    => esc_html__('Archive Layout','romancy'),
				'section'  => 'woocommerce_product_catalog',
				'settings' => 'woo_archive_layout',
				'type'     =>'select',
				'choices'  => array(
					'woo_layout_1c' => esc_html__('No Sidebar', 'romancy'),
					'woo_layout_2r' => esc_html__('Right Sidebar', 'romancy'),
					'woo_layout_2l' => esc_html__('Left Sidebar', 'romancy'),
				)
			));
	    	...
	    	$wp_customize->add_control('woo_archive_show_title', array(
	    		'label'    	=> esc_html__('Show/Hide Title','romancy'),
	    		'section'  	=> 'woocommerce_product_catalog',
			...
			$wp_customize->add_section( 'product_detail' , array(
			    'title' 	=> esc_html__( 'Product detail', 'romancy' ),
			    'priority' 	=> 30,
			    'panel' 	=> 'woocommerce',
			) );
			...
			$wp_customize->add_control('woo_product_layout', array(
				'label'    => esc_html__('Single Layout','romancy'),
