 ...
 * @since 1.0.0
 */
class Romancy_Elementor_Tabs extends Widget_Tabs {
    ...
    protected function register_controls() {
        ...
        $repeater->add_control(
            ...
            [
                ...
                'default' => esc_html__( 'Tab Title', 'romancy' ),
                'placeholder' => esc_html__( 'Tab Title', 'romancy' ),
                'label_block' => true,
                'dynamic' => [
                    'active' => true,
                ],
        ...
        $repeater->add_control(
            ...
            [
                ...
                'default' => esc_html__( 'Tab Content', 'romancy' ),
                'placeholder' => esc_html__( 'Tab Content', 'romancy' ),
        ...
        $this->add_control(
            'tabs',
            [
                'label' => esc_html__( 'Tabs Items', 'romancy' ),
                'type' => Controls_Manager::REPEATER,
                'fields' => $repeater->get_controls(),
                'default' => [
                    [
                        'tab_title' => esc_html__( 'Tab #1', 'romancy' ),
                    ...
                    [
                        'tab_title' => esc_html__( 'Tab #2', 'romancy' ),
                        'tab_content' => esc_html__( 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo.', 'romancy' ),
                    ],
                ],
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => 'horizontal',
                'options' => [
                    'horizontal' => esc_html__( 'Horizontal', 'romancy' ),
                    'vertical' => esc_html__( 'Vertical', 'romancy' ),
                ],
        ...
        $this->add_control(
            ...
            [
                ...
                'options' => [
                    ...
                    'stretch' => [
                        'title' => esc_html__( 'Justified', 'romancy' ),
        ...
        $this->add_control(
            'navigation_width',
            [
                'label' => esc_html__( 'Navigation Width', 'romancy' ),
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__( 'Navigation', 'romancy' ),
                'tab'   => Controls_Manager::TAB_STYLE,
            ]
        );
        ...
        $this->start_controls_section(
            ...
            $this->start_controls_tabs(
                ...
                $this->start_controls_tab(
                    ...
                    $this->add_control(
                        ...
                        [
                            'label'     => esc_html__( 'Color Mobile', 'romancy' ),
                            'type'      => Controls_Manager::COLOR,
                            'selectors' => [
                                '{{WRAPPER}}.elementor-widget-tabs .elementor-tabs .elementor-tabs-content-wrapper > .elementor-tab-mobile-title' => 'color: {{VALUE}}',
                            ],
                    ...
                    $this->add_control(
                        ...
                        [
                            'label'     => esc_html__( 'Background Mobile', 'romancy' ),
                            'type'      => Controls_Manager::COLOR,
                            'selectors' => [
                                '{{WRAPPER}}.elementor-widget-tabs .elementor-tabs .elementor-tabs-content-wrapper > .elementor-tab-mobile-title' => 'background-color: {{VALUE}}',
                            ],
            ...
            $this->add_responsive_control(
                ...
                [
                    'label'         => esc_html__( 'Border Radius (first-child)', 'romancy' ),
                    'type'          => Controls_Manager::DIMENSIONS,
                    'size_units'    => [ 'px', '%', 'em' ],
                    'selectors'     => [
            ...
            $this->add_responsive_control(
                ...
                [
                    'label'         => esc_html__( 'Border Radius (last-child)', 'romancy' ),
                    'type'          => Controls_Manager::DIMENSIONS,
                    'size_units'    => [ 'px', '%', 'em' ],
                    'selectors'     => [
...
$widgets_manager->register(new Romancy_Elementor_Tabs());