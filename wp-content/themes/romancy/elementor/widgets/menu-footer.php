...
class Romancy_Elementor_Menu_Footer extends Widget_Base {

	
	public function get_name() {
		return 'romancy_elementor_menu_footer';
	}

	
	public function get_title() {
		return esc_html__( 'Menu Footer', 'romancy' );
	}
...
$widgets_manager->register( new Romancy_Elementor_Menu_Footer() );