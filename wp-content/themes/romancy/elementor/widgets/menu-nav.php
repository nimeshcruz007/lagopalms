...
class Romancy_Elementor_Menu_Nav extends Widget_Base {

	public function get_name() {
		return 'romancy_elementor_menu_nav';
	}

	public function get_title() {
		return esc_html__( 'Menu', 'romancy' );
	}
	...
	protected function register_controls() {
		...
		$this->start_controls_section(
			'section_content',
			[
				'label' => esc_html__( 'Parent Menu', 'romancy' ),
			]
		);
			...
			$this->add_responsive_control(
				'menu_a_padding',
				[
					'label' => esc_html__( 'Content Padding', 'romancy' ),
					'type' => Controls_Manager::DIMENSIONS,
					'size_units' => [ 'px', 'em', '%' ],
					'selectors' => [
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Sub Menu', 'romancy' ),
			]
		);	
			...
			$this->add_control(
				...
				[
					'label' => esc_html__( 'Background Item Hover', 'romancy' ),
					'type' => Controls_Manager::COLOR,
					'default' => '',
					'selectors' => [
	...
	protected function render() {
		...
		<nav class="main-navigation">
            <button class="menu-toggle">
            	<span>
            		<?php echo esc_html__( 'Menu', 'romancy' ); ?>
            	</span>
            </button>
			<?php
				wp_nav_menu( [
...
$widgets_manager->register( new Romancy_Elementor_Menu_Nav() );
