...
class Romancy_Elementor_Logo extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Logo', 'romancy' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					'home' => esc_html__( 'Home Page', 'romancy' ),
					'none' => esc_html__( 'None', 'romancy' ),
					'custom' => esc_html__( 'Custom URL', 'romancy' ),
				],
				'default' => 'home',
		...
		$this->add_control(
			...
			[
				...
				'placeholder' => esc_html__( 'https://your-link.com', 'romancy' ),
				'condition' => [
					'link_to' => 'custom',
				],
				'show_label' => false,
		...
		$this->add_control(
			'desk_logo',
			[
				'label' => esc_html__( 'Desktop Logo', 'romancy' ),
		...
		$this->add_control(
			'desk_w',
			[
				'label' => esc_html__( 'Desktop Logo Width', 'romancy' ),
		...
		$this->add_control(
			'desk_h',
			[
				'label' => esc_html__( 'Desktop Logo Height', 'romancy' ),
				'type' => Controls_Manager::SLIDER,
				'size_units' => [ 'px' ],
				'range' => [
					'px' => [
		...
		$this->add_control(
			'mobile_logo',
			[
				'label' => esc_html__( 'Mobile Logo', 'romancy' ),
				'type' => Controls_Manager::MEDIA,
				'dynamic' => [
					'active' => true,
				],
		...
		$this->add_control(
			'mobile_w',
			[
				'label' => esc_html__( 'Mobile Logo Width', 'romancy' ),
				'type' => Controls_Manager::SLIDER,
				'size_units' => [ 'px' ],
				'range' => [
					'px' => [
		...
		$this->add_control(
			'mobile_h',
			[
				'label' => esc_html__( 'Mobile Logo Height', 'romancy' ),
				'type' => Controls_Manager::SLIDER,
				'size_units' => [ 'px' ],
				'range' => [
					'px' => [
		...
		$this->add_control(
			'sticky_logo',
			[
				'label' => esc_html__( 'Sticky Logo', 'romancy' ),
				'type' => Controls_Manager::MEDIA,
				'dynamic' => [
					'active' => true,
				],
		...
		$this->add_control(
			'sticky_w',
			[
				'label' => esc_html__( 'Sticky Logo Width', 'romancy' ),
				'type' => Controls_Manager::SLIDER,
				'size_units' => [ 'px' ],
				'range' => [
					'px' => [
		...
		$this->add_control(
			'sticky_h',
			[
				'label' => esc_html__( 'Sticky Logo Height', 'romancy' ),
				'type' => Controls_Manager::SLIDER,
				'size_units' => [ 'px' ],
				'range' => [
					'px' => [
...
$widgets_manager->register( new Romancy_Elementor_Logo() );