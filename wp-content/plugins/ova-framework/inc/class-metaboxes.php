...
if( !class_exists('Romancy_Metaboxes') ){
    
    class Romancy_Metaboxes {
        ...
        function add(){
            ...
            add_meta_box(
                ...
                apply_filters( 'romancy_set_header_version' ,array( 'post', 'page' ) )                  // Post type
            );
        ...
        function general_setting( $post ) {
            ...
            $list_header = apply_filters('romancy_list_header', '') != '' ? array_merge( array( 'global' => 'Global' ),  apply_filters('romancy_list_header', '') ) : array( 'global' => 'Global' );
            ?>
            ...
            $list_footer = apply_filters('romancy_list_footer', '') != '' ? array_merge( array( 'global' => 'Global' ),  apply_filters('romancy_list_footer', '') ) : array( 'global' => 'Global' );
            ?>
            ...
            $layouts = apply_filters('romancy_define_layout', '') != '' ? array_merge( array( 'global' => 'Global' ),  apply_filters('romancy_define_layout', '') ) : array( 'global' => 'Global' );
            ?>
            ...
            $wide_site = apply_filters('romancy_define_wide_boxed', '') != '' ? array_merge( array( 'global' => 'Global' ),  apply_filters('romancy_define_wide_boxed', '') ) : array( 'global' => 'Global' );
            ?>
